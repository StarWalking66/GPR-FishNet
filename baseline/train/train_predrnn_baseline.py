...
def main():
    ...
    SAVE_DIR = "./model_outcomes/checkpoints_predrnn_baseline"
    ...
    for seed in SEEDS:
        ...
        model = PredRNN(in_chans=8, hidden_dim=64, img_size=(64, 96), num_layers=2).to(device)
        ...
        best_model_path = os.path.join(run_save_dir, "best_predrnn.pth")
        print(f"Starting PredRNN baseline training with seed={seed}...")
        ...
        print("\nPredRNN final one-step test metrics:")
        for metric_name, metric_value in one_step_metrics.items():
            print(f"  {metric_name}: {metric_value:.6f}")
        print("\nPredRNN final 2024 rollout metrics:")
